...
actividades = 0
registro_de_tiempo = 0
opcion = 0 
print("Bienvenido a registro de actividades diarias")
opcion = print("ingrese su opcion 1-registro de actividades opcion 2- mostrar analisis de tiempo 3- Salir")

while opcion != 3:

    if opcion == 1:
        print = int(input("ingrese el numero de actividades a realizar hoy"))

    elif opcion == 2:
        print = int(input("ingrese la cantidad de minutos"))
