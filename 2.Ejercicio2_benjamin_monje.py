...
print("menu de opciones \nopcion_1) registrar_actividades \nopcion_2) mostrar_analisis_de_tiempo \nopcion_3) salir") 
...
int = input(print("seleccione una opcion"))

registro_de_actividades = 0
minutos = 0 
...
while True:
    if opcion_1:
        ...
        input(print("ingrese_cantidad_de_actividades"))
        input(print("ingrese_nombre_de_actividad"))
        input(print("ingrese_duracion_de_actividad"))
        break

        registro_de_actividades >=3
