...
Restricciones: No uses la función rápida `sum()`. Extrae solamente los números usando la herramienta `.values()` 
y súmalos uno por uno adentro de un ciclo `for`. Imprime el total. """
