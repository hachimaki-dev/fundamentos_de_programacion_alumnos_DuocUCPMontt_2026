...
print(f"El dinero que te falta para conseguir el auto de tus sueños es $", auto_soñado - ahorro_inicial)

dinero_faltante = auto_soñado - ahorro_inicial
print(f"Por lo tanto para conseguir todo el dinero necesario ahorrando ${ahorro_mensual} por mes necesitarias ahorrar durante", dinero_faltante // ahorro_mensual ," meses, con un margen de error de $50.000 pesos")