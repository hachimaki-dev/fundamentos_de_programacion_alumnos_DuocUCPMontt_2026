...
opcion_menu = int(input("Seleccione una opcion (1, 2 o 3.): "))

opcion_menu == 1
cantidad_actividades = int(input("ingrese la cantidad de actividades que quiere registrar: "))

while True:
    if cantidad_actividades >= 3:
        nombre_actividad = input("Nombre de la actividad quiere registrar?: ") * cantidad_actividades
        nombre_actividad * cantidad_actividades
        contador_actividad += 1
        minutos_actividad = int(input("Minutos de actividad: "))
        contador_minutos = contador_minutos + minutos_actividad
    elif contador_actividad >= 3:
        print("debe ingresar 3 o mas actividades")
        break

if opcion_menu == 2:
    print("--Estas en tu análisis del tiempo--") 
