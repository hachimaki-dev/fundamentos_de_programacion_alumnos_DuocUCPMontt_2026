...
#Restricciones: Usa un `for` usando `.values()` para sumar los bonos.
#Usa otro `for` usando `.values()` para recorrer los porcentajes de descuento, calcular la plata que significan, y restarlos. Imprime el sueldo líquido final.
sueldo_base = 800000
total_bonos = 0
