...
while True:
    ...
    opcion_menu_principio = input("¿Que desea hacer?")
    if opcion_menu_principio == "1":
        actividades_registradas = int(input("¿Cuantas actividades desea registrar?"))

        while actividades_registradas < 3:
            actividades_registradas = int(input("Minimo 3 actividades"))

        while actividades_registradas != contador:
            tiempo_total = 0
            nombre_actividad = input("Nombre de la actividad")
            actividades = actividades + [nombre_actividad]
            tiempo_actividad = int(input("tiempo de la actividad en minutos"))
            tiempo_total = tiempo_total + tiempo_actividad
            contador = contador + 1

    elif opcion_menu_principio == "2" and actividades_registradas >= 3:
        print(f"Tiempo total de actividades registradas en minutos {tiempo_total}min")
        print("")
        print("Evaluacion de actividades: ")
        if tiempo_total > 180:
            print("Tiempo diario excesivo")
        else:
            print("Tiempo diario adecuado")

    elif opcion_menu_principio == "3":
