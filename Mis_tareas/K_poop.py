...
respuesta=""
print("Cual es tu grupo favorito?")
while respuesta != "BTS" and respuesta!= "BLACK PINK" and respuesta != "STRAY KIDS":
    respuesta = input("Si quieres entrar al club k-poper dinos el nombre de tu banda favorita").upper()
