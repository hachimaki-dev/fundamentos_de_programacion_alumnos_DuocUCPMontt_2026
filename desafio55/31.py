...
#Restricciones: Usa la herramienta `.append()` para meter cosas al final de la lista. Usa `.insert(0, ...)`
#para obligar a una canción a ponerse en la posición cero (el principio). Imprime la lista completa al terminar.
canciones = ["B", "C"]
canciones.append("D")
