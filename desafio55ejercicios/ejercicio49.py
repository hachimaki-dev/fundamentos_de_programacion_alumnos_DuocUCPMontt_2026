...
Restricciones: Como es un diccionario dentro de otro, tienes que encadenar los corchetes (ej. `diccionario['llave_padre']['llave_hijo']`) dentro de tu `if`.
 Si tiene permiso imprime 'Creando instancia', sino imprime 'Acceso Denegado'. """

usuario_datos = {'rol': 'dev', 
    'permisos': {'S3': True, 'EC2': False}
}
if usuario_datos['permisos']["EC2"]:
