...
Restricciones: Combina `or` y `and` en un mismo `if`. 

Usa paréntesis para agrupar la Opción B y que Python no se confunda. Imprime `'Cliente VIP'` o `'Cliente Normal'`."""
...
if Ganancia_Cliente >= 1000000 or Años >= 5 and Deudas == 0:
    print("Eres VIP")