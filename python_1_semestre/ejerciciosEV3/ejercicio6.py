...
while contador == 0 :
    patente = input("ingrese su patente: ").upper()# el input devuelve todo en str por defecto incluso numeros y decimales
    tamano_patente = len(patente)
    if tamano_patente == 6 and " " not in patente:
        print(patente)
        contador +=1
