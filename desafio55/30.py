...
codigos_respuesta = [200, 404, 500, 200, 500]
reintentos = 1

for intentos in codigos_respuesta:
    if codigos_respuesta == "200":
        print("Ok")
    elif codigos_respuesta == "404":
        print("No encontrado")
    elif codigos_respuesta == "500":
        print("Reintentando")
        reintentos = reintentos - 1
        print("Te has quedado sin reintentos.")
    elif codigos_respuesta == "500":
