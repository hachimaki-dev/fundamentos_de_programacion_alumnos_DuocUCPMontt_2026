...
#Usa un `for` combinado con `range(len(lista))` para recorrer las posiciones. Sobreescribe multiplicando por 2 e imprime la lista modificada.
partidas = [100, 200, 300]
for i in range(len(partidas)):
    partidas[i] = partidas[i] * 2
