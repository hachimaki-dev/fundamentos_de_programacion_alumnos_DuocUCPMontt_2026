'''Desarrolle un programa que genere un número aleatorio dentro de un rango y luego lo ajuste al múltiplo de 5 inmediatamente menor o igual.

Debe utilizar: ajustado = (numero // 5) * 5
