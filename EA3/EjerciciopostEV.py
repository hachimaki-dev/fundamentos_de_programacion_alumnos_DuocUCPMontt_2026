...
for i in range(cantidad):
    ...
    if puntaje > 80:#Primer Error es solamente mayor que 80 no es mayor o igual que 
...
promedio = suma_puntajes / aptos #En esta division podria dar un ZeroDivisionError 
print(f"\n=== RESUMEN DE LA MISIÓN ===")
print(f"Aptos para misión: {aptos}")
print(f"En entrenamiento: {entrenamiento}")
print(f"Promedio general: {promedio}")#No dan los dos decimales que piden en los requisitos 