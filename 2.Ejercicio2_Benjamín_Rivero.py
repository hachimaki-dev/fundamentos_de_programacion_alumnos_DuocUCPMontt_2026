...
print("\n ### REGISTRO DE ACTIVIDADES DIARIAS ###")
while True:
    print("\n MENÚ DE ACTIVIDADES \n1.Registrar actividades \n2.Mostrar analisis de tiempo. \n3.SALIR")             
    accion_menu = int(input("¿Que opción escogerá?\n"))
    if accion_menu == 1:
        cantidad_actividades= 0
        tiempo_actividades = 0
        cantidad_act = int(input("Ingrese la cantidad de actividades que realizará, deben ser minimo 3. "))
        if cantidad_act >= 3:
            cantidad_actividades += cantidad_act
            for i in range(1,cantidad_act +1):
        ...
        print(f"La cantidad de actividades realizadas es de {cantidad_actividades}.")
        if tiempo_actividades>180:
