...
maquina_escribir("?: Te despiertas temprano, te encuentras sin emoción alguna")
maquina_escribir("?: Un guardia pasa por tu celda...")
pausa(1)
maquina_escribir("?: Se te queda viendo")
...
maquina_escribir(f"Guardia: Así que {nombre}...")
maquina_escribir(f"{nombre}: Así es")
for letras in nombre:
    if len(letras) < 5:
        print("Guardia: Que nombre tan ridiculo!!!")
        break
    else:
        print("Guardia: Que nombre tan peculiar")
        break
