...
entradas = int(input("cuantas entradas vas a comprar ?"))
contador = 0
total = 0

while contador < entradas:
    edad = int(input("cual es la edad de cada persona ?: "))

    if edad < 12:
        print("la entrada cuesta 3000")
        total += 3000
        contador +=1
    
    elif edad >= 12 and edad <= 64:
        print("la entrada cuesta 6000")
        total += 6000
        contador +=1
    
    elif edad > 65:
        print("la entrada cuesta 4000")
        total +=4000
        contador+=1
