...
while True: 
    ...
    if desicion1 == "1" or desicion1 == "2":
        ...
        if desicion2 == "1":
            ...
            print("\nTe ha matado EL ABOGADO DEL DIABLO")
            ...
            desicion3 = input("\n(1. Subir por la cascada y buscar algo | 2. Bajar a la cueva) Que haras?: ")

            if desicion3 == "1":
                print("\nHan tratado de subir por la cascada pero pierden el equilibrio y caen")
                ...
                print("\nerror: Como escalas una cascada? jajaja")
                ...
                print("\nUn par de horas despues, los Junaboys escuchan ruidos afuera de la cueva, deben decidir si salir a investigar o quedarse en la cueva")
                desicion4 = input("\n(1. salir a investigar | 2. quedarse en la cueva) Que quieres hacer?: ")
                ...
                if desicion4 == "1":
                    ...
                    print("\nobservan un rio, aunque la corriente es violenta creen que existe la posibilidad de cruzar")
                    
                    desicion5 = input("\n(1. cruzar el rio | 2. rodear el bosque) que haras?: ")

                    if desicion5 == "1":

                        print("\nla corriente los arrastra, los Junaboys no lograron salvarse")
                        ...
                        if desicion6 == "1":
                            ...
                            if desicion7 == "1":
                                ...
                                desicion8 = input("\n(1. luchar contra EL ABOGADO DEL DIABLO | 2. Escapar) cual sera tu desicion?: ")
                                ...
                                if desicion8 == "1":
                                    ...
                                    print("\ndeciden que escapar hasta el amanecer es la mejor opcion, pero sera dificil. el ABOGADO DEL DIABLO debe estar cerca...")

                                    desicion9 = input("\n1. tratar de regresar a casa | 2. mantenerse en la zona: ")

                                    if desicion9 == "1":

                                        print("\ntodos estan de acuerdo en que es buena idea regresar a casa con cautela, quizas en casa encuentren algun arma") 
                                        print("\nDespues de muchas circunstancias desafortunadas, los chicos logran llegar a casa, pero se percatan de algo")
                                        print("\nEl padre de franco no esta en casa...")
                                        input("\npresiona enter para continuar...")
                                        print("\nDespues de revisar un poco, los Junaboys logran encontrar objetos para defenderse")

                                        armas = ["Escopeta", "Rifle", "Glock"]
                                        print("\nlos Junaboys logran observar al ABOGADO DEL DIABLO corriendo hacia la casa, deben decidir que hacer Rapido")
                                        desicion10 = input("\n1. Elegir arma / 2. Escapar de la casa: ")

                                        if desicion10 == "1":

                                            print(f"{armas}")
                                            elegir_arma = input("Que arma escogen los junaboys?: ")
                                            print(f"\nHas escogido {elegir_arma}")
                                            print("ahora deben decidir....")
                                            
                                            disparar = input("\nDisparar al ABOGADO DEL DIABLO... o no? (SI/NO): ").strip().lower()
                                            if disparar == "si":
                                                print("\nHan disparado, el ABOGADO DEL DIABLO ha caido muerto en el cesped...")
                                                print("\nEs hora de descubrir quien es")
                                                input("\nSi desea descubrir quien es el ABOGADO DEL DIABLO, presione enter...")
                                                print("\nlos Junaboys se acercan para descubrir que el horroroso rostro del ABOGADO DEL DIABLO no era mas que una mascara")
                                                print("\nUna vez que quitan la mascara, el rostro del padre de Franco fue revelado")
                                                input()
                                                print("\nLos Junaboys lloraron con cierta calma al saber que la pesadilla habia acabado, eran las 5:30 AM ")
                                                input()
                                                ...
                                                print("\nDudaste... El Abogado del Diablo entró a la casa. Nadie sobrevivió.")
                                        else:
                                            print("\nIntentaron escapar por la puerta trasera, pero el Diablo fue más rápido. Los alcanzó en el patio.")
                                        ...
                                        print("\nLos Junaboys, muertos de cansancio deciden resistir.... pero no fue una buena desicion")
                                        input("")
                                        print("D\nespues de horas escapando, los chicos no pueden evitar preguntarse, el padre de franco, era un granjero amigable ex abogado que dejo de ejercer en circunstancias desconocidas")
                                        print("\ny lo mas extraño de todo, ¿porque no lo hemos visto desde que llegamos?....")
                                        input("\nPresiona enter para continuar: ")
                                        ...
                                        print("\nlos Junaboys nunca fueron encontrados, fueron reportados como desaparecidos y quedaron en el olvido mientras el ABOGADO DEL DIABLO sigue fingiendo ser nada mas que... un amigable granjero")
                            else: 
