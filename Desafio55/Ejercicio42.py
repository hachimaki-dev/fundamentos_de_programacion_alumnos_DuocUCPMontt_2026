...
Dile a Python que vaya a la llave `'puntos'` y le sume `+ 300` a lo que sea que haya adentro. Imprime el diccionario completo para ver el cambio."""
...
Datos_Iniciales["Puntos"] += 300


print(f"Puntos: {Datos_Iniciales["Puntos"]}")