...
print("###"*15)
print(" R e g i s t r o   d e    a c t i v i d a d e s   d i a r i a s ")
print("###"*15)

cantidad_actividades_ingresadas = 0
tiempo_total = 0


while True:
    print("M  e n u:\n1. Registrar actividades\n2. Mostrar análisis del tiempo\n 3. Salir")
    opcion = int(input("Ingrese que opcion Desea Realizar (1/2/3):  "))
    if opcion == 1:
        solicitar_actividades = int(input("Cuantas actividades desea Registrar :  "))
        if solicitar_actividades >= 3:
            nombre_actividad = input("Cual es el Nombre de la Actividad que Realizo :    ")
            tiempo_actividad = int(input("Cuanto tiempo Toma dicha Actividad (en minutos):  "))
            tiempo_total += tiempo_actividad
            cantidad_actividades_ingresadas += 1
            print("Proceso Terminado Selecione que mas Desea Hacer")
            continue
        else:
            print("A realizado Pocas actividades")
            continue
    elif opcion == 2:
        print(f"El tiempo total de las actividades registradas es {tiempo_total}")
        if tiempo_total > 180:
            print("Tiempo diario excesivo")
            print("Que mas desea Revisar")
        elif tiempo_total < 180:
            print("Tiempo diario adecuado")
            print("Que mas desea Revisar")
            continue
    elif opcion == 3:
        print("Fin del registro")
        print(f"El total actividades realizadas es :  {solicitar_actividades}\nTiempo total realizado de las Actividades:  {tiempo_total}")
        break
