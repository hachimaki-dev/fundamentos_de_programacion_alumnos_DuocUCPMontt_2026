...
while contador < 5:
    ...
    try :
        temperatura_ingresada = float(input("Ingrese la temperatura mostrada"))
        if temperatura_ingresada > 80:
            sensores_temperatura["temperatura_critica"] = temperatura_ingresada
            print(f"Alerta : temperatura critica")
        elif temperatura_ingresada >= 50 and temperatura_ingresada <= 80:
            sensores_temperatura["normal_operativa"] = temperatura_ingresada
            print("Temperatura normal operativa")
        elif temperatura_ingresada < 50:
            sensores_temperatura["temperatura_baja"] = temperatura_ingresada
            print("Temperatura baja")
        else:
            print("No corresponde a ninguno")
        contador = contador + 1
    except Exception as errores_lectura:
        print(f"Temperatura no corresponde a valor ingresado , recuerde que debe ser exacta {errores_lectura}")
