...
Reglas de Negocio: Evidentemente, una venta no puede ser menor o igual a 0. Esos son errores del sistema. 
Necesitas sumar todas las ventas buenas y simplemente IGNORAR las malas, sin detener el ciclo.
...
Las_ventas_del_día = [1500, -200, 5000, 0, 100]
total = 0

for ventas_positivas in Las_ventas_del_día:
    if ventas_positivas <= 0:
        continue
    
    total = total + ventas_positivas
