...
tiempotot = 0
actividad=""
print("Bienvenido al registro de actividades")
while True:
    print("===============================")
    ...
    print("3-Salir")
    print("===============================")
    eleccion = int(input("¿Que accion desea ejecutar? "))
    if eleccion == 1:
        tiempotot=0
        cantidad2=0
        cantidad = int(input("¿Cuantas actividades desea ingresar? (ingrese 3 o más actividades) "))
        if cantidad >= 3:
            while cantidad2 < cantidad:
                actividad=input("Ingrese nombre de actividad: ")
                tiempo= int(input("Cuanto tiempo le lleva (en minutos): "))
                cantidad2+=1
                tiempotot=tiempo + tiempotot
                print(f"la actividad {cantidad2} {actividad} le toma {tiempo} minutos") 
        else:
            print(" Tiene que ingresar tres o más actividades")
    elif eleccion ==2: 
        if tiempotot < 180:
            print(f"El tiempo es {tiempotot}")
