...
Restricciones: No escribas la lista de nuevo a mano, eso es trampa. Usa la herramienta `.remove()`
escribiendo exactamente el nombre del jugador que quieres borrar. Imprime la lista limpia."""
