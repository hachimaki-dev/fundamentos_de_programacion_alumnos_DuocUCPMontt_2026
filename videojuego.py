...
nombre_jugador = input("Antes de comenzar la travesia, cual es tu nombre? ")

print(f"Bienvenido, {nombre_jugador}. La historia esta por comenzar...")

print("Entre las catacumbas se encuentra un misterio que puede decifrar la clave del origen y sus capas de la realidad, quien lo encuentre estara destinado a revelar la verdad, pero quien se atrevera a ingresar al mismismo infierno y poder salir vivo?")
...
accion = input("Tu eleccion (A,B,C): ")

if accion == "A":
    print("No se inmuta. Continua limpiando su vaso, y dice lo siguiente")
    print(f"El dinero no compra la verdad en mi cantina {nombre_jugador}, Solo hace que tu muerte sea mas rapida")

if accion == "B":
    print("Pasa un rato y Charles decide hablar")
    print("Te noto un poco confuso, si vas a pedir algo hazlo ahora o largate de aqui")
...
if accion == "C":
    ...
    confirmacion = input("¿Estas listo para descender a la oscuridad? (si/no): ")
    ...
    if confirmacion == "si":
        ...
        print(f"\nVamos {nombre_jugador}, ven a beber hasta olvidarte de quien eres")
