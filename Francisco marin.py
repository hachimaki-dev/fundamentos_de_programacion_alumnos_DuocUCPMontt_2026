...
while True:
    print("1.registro actividades")
    print("2.analisis del tiempo")
    print("3.salir")
   
    opcion=int(input("seleccione una opcion"))
    if opcion == 1:
         registro_actividades=int(input("realizo voleiball"))
        print("la actividad del usuario fue voleiball")
    
    if opcion==2:
        
        analisis_del_tiempo=int(input("hoy dia lluvioso"))
        print("el dia de hoy se pronuncia lluvia desde las 11:00am hasta las 12:00am")
        
    else:
        
        print("el dia de hoy se pronuncia un dia soleado las 11:00am hasta las 12:00am")
        
    if opcion == 3 :
        print("el usuaria a cerrado session")
         break                    