...
for i in range(cantidad):
    ...
    if poder >= 71:
        ...
        fenix += 1
    elif poder >= 40:#Deberia ser >= 41, de esta manera el numero 40 debe entrar en casa del buho
    ...
    if poder > mejor_poder:
        mejor_nombre = nombre
        #Nunca actualiza las variables y se mantiene asi

print(f"\n✨ RESULTADOS DE LA CLASIFICACIÓN ✨")
print(f"Casa del Fénix: {fenix}")
print(f"Casa del Grifo: {grifo}")
print(f"Casa del Búho: {buho}")
print(f"Aprendiz más poderoso: {mejor_nombre} con poder {mejor_poder}")#El poder nunca cambia de valor y se mantiene constantemente en 0
#Siempre imprime el ultimo nombre ingresado, pero no el nombre del mas poderoso 