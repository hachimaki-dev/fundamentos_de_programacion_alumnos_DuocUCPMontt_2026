...
Usa división entera (`//`) para saber cuántos billetes entregar, 
y guárdalo en tu diccionario como `diccionario[billete] = cantidad`. 
Luego, usa el módulo (`%`) para actualizar la plata que te falta por repartir. Imprime el diccionario con el desglose exacto al terminar.'''

Billetera = {20000 : 0, 10000 : 0, 5000 : 0, 1000 : 0}


Dinero_Que_Se_Quiere_Sacar = 37000

for Dinero, Cantidad in Billetera.items():

    Cantidad = Dinero_Que_Se_Quiere_Sacar//Dinero
    Billetera[Dinero] = Cantidad
    Dinero_Que_Se_Quiere_Sacar -= Dinero
