#Ejercicio 52: Ejercicio 52: Calculadora de Liquidación Real
...
base = sueldo_base #Esto es para guardar el sueldo base y realizar los descuentos
...
for descuento in descuentos.values():
    sueldo_base -= (base * descuento)

print(int(sueldo_base))