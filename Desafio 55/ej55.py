...
#Pista de Ayuda:
#Usa división entera // para la cantidad de billetes, y actualiza el retiro = retiro % denominacion.

retiro = 37000
billetes_existentes = [20000, 10000, 5000, 1000]
resultados ={}

#Ordenamos los billetes
billetes_existentes.sort(reverse = True)

#Recorremos la lista
for billete in billetes_existentes:
    cantidad = retiro // billete
    resultados[billete] = cantidad
    retiro %= billete
