...
Restricciones: Ordena la lista de mayor a menor usando `.sort(reverse=True)`. Después, usa la técnica de rebanado de listas (slicing) escribiendo `[:3]` 
para atrapar solo a los ganadores. Imprime esa rebanada."""


venta_productos_cantidad = [500, 1000, 200, 800, 1500]


venta_productos_cantidad.sort(reverse=True)
top3 = venta_productos_cantidad[:3]
print(top3)