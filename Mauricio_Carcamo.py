...
bailar = 0
cantar = 0
Registrar_actividades = correr + bailar + cantar
...
while True:
    ...
    input("selecciones una opcion: ")

    opcion = 1
    input("cantidad de acvidades diarias: ")
    Registrar_actividades += 1
    actividad = input("nombre de las actividades: ")

    if Registrar_actividades >= 3:
        input(f"Solicitar la cantidad de actividades a registrar:  {Registrar_actividades}")
     
        print("Esta es la cantidad de mis actividades diarias:")
        input("Nombres de las actividades")
