...
def mostrar_menu():
    ...
    print("6. Salir")
    print("7. Agregar datos")


def opcion_menu_usuario():
    while True:
        opcion_elegida = input("Ingrese su opción (1 al 7): ")
...
def eliminar_bicho_por_nombre(nombre_del_bicho_a_eliminar):
    index_bicho_eliminar = buscar_bicho_por_nombre(nombre_del_bicho_a_eliminar)
    lista_de_todos_los_bichos.pop(index_bicho_eliminar)
    return True

def rellenar_lista_con_datos():
    lista_de_todos_los_bichos.append({
        "nombre_bicho": "mariposa",
        "longitud_bicho": 3,
        "peligrosidad_bicho": 3.2,
        "es_peligroso": False
    })
    lista_de_todos_los_bichos.append({
        "nombre_bicho": "pulga",
...
def actualizar_estado_de_peligrosidad():
    for cada_bicho in lista_de_todos_los_bichos:
        if cada_bicho['peligrosidad_bicho'] >= 7.0:
            cada_bicho['peligrosidad_bicho'] = True
