...
ganancia_polera = valor_polera - costo_tela - costo_estampado - costo_empaque
ganancia_total = ganancia_polera * poleras_vendidas
print(f"La ganancia de este mes es de {ganancia_total}")