...
# Reglas de Negocio: Solo sirven los nombres reales. 
# Los espacios en blanco (' '), las respuestas vacías ('') o los datos nulos (`None`) se consideran basura y hay que botarlos. 
...
entrada_formulario = ['Juan', None, '', 'Ana', ' ']
entrada_valida = []

for respuesta in entrada_formulario:
     if respuesta is not None and respuesta.strip() != '':
        entrada_valida.append(respuesta)

print(entrada_valida)
