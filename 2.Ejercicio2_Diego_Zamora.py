...
while True:
    ...
    if opcion < 0 or opcion > 3:
        ...
        cantidad = int(input("Ingrese la cantidad de actividades diarias "))
        nombreactividad = input("Ingrese el nombre de la actividad ")
        for i in range(cantidad):
            tiempo = int(input("Ingrese los minutos/tiempo toma cada actividad diaria "))
            tiempototal += tiempo
    
    elif opcion == 2:
        print(f"El tiempo total que toma la actividad {nombreactividad} es de {tiempototal} minutos")
        if tiempototal > 180:
            print("Tiempo diario excesivo")
        elif tiempototal <= 180:
            print("Tiempo total Adecuado")
