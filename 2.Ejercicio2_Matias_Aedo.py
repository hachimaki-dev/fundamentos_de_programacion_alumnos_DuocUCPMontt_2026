...
actividades = 0 #contador
numero_actividades = 0
tiempo = 0 #acumulador

while True:
    if numero_actividades != actividades:
        if numero_actividades != 0:
            input("¿nombre de la actividad? ")
            print("¿cuánto tiempo te tomó las actividades una a una? (en minutos)")
            tiempo += int(input())
            actividades += 1
            continue
    print("--------------------------------------------------------")
    print("Elegir una de 3 opciones:")
    print()
    ...
    if opcion == 3:
        ...
        print("¿cuántas actividades hiciste hoy?")
        numero_actividades = int(input())
        if numero_actividades <= 2:
            print("tienen que ser al menos 3")
            numero_actividades = 0
        elif numero_actividades >= 3:
            input("¿nombre de la actividad? ")
            print("¿cuánto tiempo te tomó las actividades una a una? (en minutos)")
            tiempo += int(input())
            actividades += 1
        ...
        if tiempo > 180:
            print(f"Tiempo diario excesivo {tiempo} min")
        elif tiempo <= 180:
            print(f"Tiempo diario adecuado {tiempo} min")
#ciclo infinito si se elige la opción 2 por segunda vez