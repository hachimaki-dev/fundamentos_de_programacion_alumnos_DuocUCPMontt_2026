...
mochila = ["Mapa", "Espada"]
objetos_piso = ["Madera", "Piedra", "Oro"]
cantidad_max_mochila = 4

for objetos in objetos_piso :
    print(f"Has añadido ", [objetos], " a tu mochila")
    mochila.append(objetos)
    print("Tienes: ", len(mochila) ," objetos en la mochila")
    if len(mochila) == cantidad_max_mochila :
        print([mochila])
        print("Has alcanzado el limite de tu mochila, consiguete una mejor")
        break