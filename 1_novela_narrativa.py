...
print(f"Te devuelves con el cabo y le reportas tu descubrimientos *'Ah, entonces el sujeto tenia una {motivo_del_crimen}, empieza a tener sentido, el sujeto claramente no tenia ayuda, sino hubieramos encontrado medicina en algun sector del apartamento, pero lo ultimo que tenemos que deducir es porque asesino a su jefe? Que tenia el que ver con esto?'* Claro, era hora de comparar nuestra evidencia para ver si podemos encontrar un motivo claro para aclarar el crimen \n")
while contador == True:
