...
print("Si cumples con todos estos pasos previamente mencionados el saldo de tu tarjeta al final del día sería: $", saldo - pasaje_micro - pasaje_metro * 2 + recarga_bip ," pesos.")