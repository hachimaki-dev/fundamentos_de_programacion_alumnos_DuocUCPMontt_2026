...
while True:
    ...
    if opcion == 1:
        int(input("ingrese numero de actividades: "))
        if actividad >= 3:
            actividad = print("\n cantidad de actividad normal")
        else:
            print("cantidad de actividades baja")
        tiempo_actividad = int(input("ingrese minutos el tiempo que realizo las actividades"))
        print(f"el tiempo de las actividades es: {tiempo_actividad}.")
        
            
    if opcion == 2:
        print(f"El tiempo de actividad es: {tiempo_actividad} ")
        if tiempo_actividad >= 180:
            input("tiempo diario adecuado")
        else:
