...
while True:
    ...
    patente_vehiculo = input("Ingrese su patente: ")

    tiene_espacios = False

    for caracteres in patente_vehiculo:
        if caracteres == " ":
            tiene_espacios = True

    if tiene_espacios == True:
        print("Patente inválida. Ingresa caracteres sin espacios.")

    elif len(patente_vehiculo) != 6:
        print("Patente inválida. Ingresa exactamente 6 caracteres sin espacio.")

    else:
        print(f"Patente Ingresada: {patente_vehiculo}")
        break
