...
while True:
        print("\n1. Iniciar Registro/ 2. Salir del Registro")
        Opcion = input("Elija una Opcion: ")
        if Opcion == "1":
            print("entrando al Registro")
            break
        elif Opcion == "2":
...
print("--------------------------------------")
print("------ REGISTRA TUS ACTIVIDADES ------")
print("--------------------------------------")
print("¿Que actividades realizas?") 

while True:
        print("\n1.Actividades Fisicas/2. Actividades Mentales/3. Actividades Familiares")
        Actividades = input ("Elija la Actividad: ")
        if Actividades == "1":
            int(input("Cual es la cantidad de horas registradas el dia de hoy: " )) 
            print("PERFECTO, GUARDANDO EN EL SISTEMA")
            break
        elif Actividades == "2":
            int(input("Cual es la cantidad de horas registradas el dia de hoy?: "))
            print("PERFECTO GUARDANDO EN EL SISTEMA")
            ...
            ("NO SELECCIONASTE NADA, PORFAVOR VUELVE A INTENTARLO")
