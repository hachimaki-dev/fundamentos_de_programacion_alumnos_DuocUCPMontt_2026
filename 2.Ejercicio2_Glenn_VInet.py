...
# Desarrolle un programa en Python que permita gestionar y analizar 
# actividades diarias, 
# calculando el tiempo total dedicado a ellas.

# El programa debe operar mediante un menú de opciones que se repite 
# continuamente hasta que el usuario decida salir.
...
# Al finalizar el registro, el programa debe volver automáticamente al 
# menú principal.
...
tiempo_de_actividades = 0
contador = 0

while True :
    print(" registro de actividades diarias")
    print("menu de opciones:\n 1_registrar actividad\n 2_analisis del tiempo\n 3_salir")

    opcion_elegida = int(input("ingrese una opcion: "))
    while opcion_elegida == 1:
        actividades_registro = int(input("ingrese cantidad de actividades a registrar: "))
        actividades_registro +=1
    tiempo_de_actividades = int(input("tiempo total actividades "))
    if actividades_registro >= 3:
            tiempo_de_actividades = int(input("tiempo total actividades "))
            input("ingrese el nombre de la actividad: ")
    
    if opcion2 == 2:
            tiempo_de_actividades = int(input(f"total acumulado de las actividades" + (tiempo_de_actividades) ))
            if tiempo_de_actividades > 180:
                print("tiempo diario excesivo")
            
            elif tiempo_de_actividades <= 180:
