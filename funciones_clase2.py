...
# def saludarCompiConParametro(nombre_del_compi):
#     print(f"Hola {nombre_del_compi}")

# saludarCompi()
# saludarCompiConParametro("Pepito")
...
# respuesta_guardada = saludarCompiConParametro()
# print(f"Esta es la respuesta: {saludarCompiConParametro}")
