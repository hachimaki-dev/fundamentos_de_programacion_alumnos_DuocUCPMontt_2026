...
acumulador_tiempo = 0
while contador_actividades <= 3:
    print("1. Registrar actividades")
    print("2. Tiempo de actividades")
    print("3. Salir")
    opcion = int(input("ingrese una opcion: "))
    if opcion == 1:
        acividades_diarias = int(input("por favor ingresar el numero de activiades diarias: "))
        if acividades_diarias <= 3:
            actividades_diarias = acividades_diarias + contador_actividades
            nombre_actividad = (input("ingrese el nombre de las actividades:"))
            tiempo_actividad = int(input("por favor ingrese el tiempo en minutos: "))
            acumulador_tiempo = tiempo_actividad + acumulador_tiempo
            print(f"{acumulador_tiempo}")
        elif acividades_diarias > 3:
           print("ingrese menos actividades")
        continue
    elif opcion == 2:
       print(f"este es su tiempo total acumulado {acumulador_tiempo}")
       if acumulador_tiempo > 180:
          print("tiempo excesivo")
       elif acumulador_tiempo <= 180:
