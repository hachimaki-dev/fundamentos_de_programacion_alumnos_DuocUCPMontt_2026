...
while True:
    print("Menú de opciones \n1)Registrar Actividad \n2)Mostrar tiempo de analisis \n3)Salir")

    eleccion_usuario_menu_principal = int(input("Eliga su opción: "))
    
    if eleccion_usuario_menu_principal == 1:

        registro_actividad_usuario = input("Registre su actividad: ")

        registro_tiempo_usuario = int(input("¿Cuanto se demora en hacer la actividad? (En Minutos): "))

        actividad = registro_actividad_usuario

        numero_actividades_contador += 1

        tiempo += registro_tiempo_usuario

    elif eleccion_usuario_menu_principal == 2:

        print(f"Su ultima actividad registrada es {actividad}")

        print(f"El total de actividades que ha registrado son {numero_actividades_contador}")

        print(f"El tiempo total en minutos de las actividades es {tiempo}")
...
############## fin del programa ########################
    elif eleccion_usuario_menu_principal == 3:

        print("Fin del registro.")

        break

############# eleccion erronea o mayor a 3 ##############

    elif eleccion_usuario_menu_principal >= 4:

        print("Debe seleccionar una opción del 1 al 3.")
