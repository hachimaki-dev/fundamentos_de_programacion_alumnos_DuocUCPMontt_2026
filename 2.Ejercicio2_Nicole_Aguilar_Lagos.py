...
total_actividades_registradas = 0
total_tiempo = 0
...
opcion_selecionada = int(input("Ingrese opción que desee realizar: "))
...
if opcion_selecionada == 1:
    ...
    while True:
        nombre_actividad = input("\nIngrese el nombre de la actividad que realiza: ")
        tiempo_por_actividad = int(input("\nIngrese cuánto demora en cada actividad (En Minutos): "))

        total_tiempo = total_tiempo + tiempo_por_actividad
        total_actividades_registradas = total_actividades_registradas + 1
    ...
    print(f"Tiempo total acumulado de las actividades registradas: {total_tiempo}")
