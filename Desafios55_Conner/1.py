...
#Ojo: estos descuentos se calculan SÓLO sobre el sueldo base (los bonos no sufren descuentos).
...
descuentos_t=descuento_salud+descuento_afp

sueldo_liquido=sueldo_base+bono_colacion+bono_movilizacion-descuentos_t
