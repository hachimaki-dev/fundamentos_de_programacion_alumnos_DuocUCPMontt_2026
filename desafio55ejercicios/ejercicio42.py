...
Restricciones: No escribas el resultado final mentalmente (eso es trampa). Dile a Python que vaya a la llave `'puntos'` y le sume `+ 300` a lo que sea que haya adentro. 
