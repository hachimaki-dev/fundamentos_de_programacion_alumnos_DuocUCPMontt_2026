...
while out == True:
    ...
    (2)Analisis de tiempo
    (3)Salir""")
    opcion_usuario = int(input("Inserte una opción: "))
    if opcion_usuario == Registrar_actividades:
        ...
        if cantidad_actividades < 3:
            ...
            while cantidad_actividades > 0:
                ...
                print(f"Ingrese el tiempo de la actividad (En minutos) {cantidad_actividades}")
                tiempo_actividad=int(input(""))
                acumulador_tiempo = acumulador_tiempo + tiempo_actividad
                cantidad_actividades = cantidad_actividades - 1
            if cantidad_actividades == 0:
                print("")
    elif opcion_usuario == analisis_tiempo:
        print("Analisis de tiempo (Tic Tac)")
        print(f"Tiempo acumulado en actividades:{acumulador_tiempo} minutos")
        if acumulador_tiempo > 180:
            print("El tiempo diario de actividades es excesivo")
        else:
            print("Tiempo diario adecuado")
    elif opcion_usuario == salir:
        out = False
    else: 
