...
opcion_seleccionada=int(input("ingrese opcion a realizar:"))

while True:
    if opcion_seleccionada == 1:
        actividades_registradas=int(input("cantidad de actividades a registrar:"))
        while actividades_registradas >= 3:
            actividades_registradas = tiempo_actividad 
            contador += 1
            
        else:
            nombre_actividad=input("favor de ingresar nombre de la actividad:")
            tiempo_actividad=int(input("cuanto tiempo demora en las actividades:"))
            tiempo_actividad += total
