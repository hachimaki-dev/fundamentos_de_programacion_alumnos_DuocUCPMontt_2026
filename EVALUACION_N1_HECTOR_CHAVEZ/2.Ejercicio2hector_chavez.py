...
tiempo_total = 0
tiempo_nuevo = 0
actividades_no_registradas = 0


while opcion != 3:
    print("1) registrar actividades / 2) mostar analisis del tiempo / 3) salir")
    opcion = int(input("escoge una opcion"))

    if opcion ==1 :
        if actividades_registradas >=3:
            actividades_registradas = actividades_registradas + actividades_diarias
            tiempo_total = tiempo_total + actividades_registradas
        elif actividades_no_registradas < 3 :
            print("deme el nombre de la actividad: ")
            print("deme el tiempo que toma dicha actividad porfavor: ")
            opcion = int(input("desida que actividad haremos, y cuanto dura porfavor: "))
            print("1) yoga entre 1 a 2 horas")
        else:
            print("2) ciclismo entre 2 a 3 horas")
            tiempo_total = tiempo_nuevo + tiempo_total
