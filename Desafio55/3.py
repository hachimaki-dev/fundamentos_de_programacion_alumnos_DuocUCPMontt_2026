...
pichangas = 2 * 15000
schops = 5 * 3500
propina_porcentaje = 0.10
consumo = schops + pichangas
propina = consumo * propina_porcentaje
monto_final = consumo + int(propina)
pago_cada_persona = monto_final / 5
print(pago_cada_persona)