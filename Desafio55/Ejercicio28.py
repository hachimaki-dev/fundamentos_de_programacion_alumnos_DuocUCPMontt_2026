...
Reglas de Negocio: El programa revisa patente por patente y va avisando en pantalla qué patente está mirando 
('Buscando en XY11...'). Si encuentra la patente robada, dice 'Sospechoso encontrado' y DEJA DE BUSCAR (no tiene sentido mirar los autos que pasaron después).
...
for Revision in Patentes:
    if Revision == "AB12":
        print("Sospechoso encontrado")
        break
    print(f"Buscando en {Revision}. . .")